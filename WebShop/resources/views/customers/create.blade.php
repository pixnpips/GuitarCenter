...
{{--            >{{ old('message') }}</textarea>--}}
            ...
            <div>
                ...
                <x-jet-input type="text" name="street" placeholder="{{ __('Street and Number') }}" value="{{ old('street')}}"
                       class="block w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm"
                />
            ...
            <div>
                ...
                <x-jet-input type="text" na<x-jet-label for="postal" value="{{ __('Postal') }}" />me="postal" placeholder="{{ __('Postal Code') }}" value="{{ old('postal')}}"
                       class="block w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm"
                />
            ...
            <div>
                ...
                <x-jet-input type="email" name="email" placeholder="{{ __('Email') }}" value="{{ old('email')}}"
                       class="block w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm"
                />
